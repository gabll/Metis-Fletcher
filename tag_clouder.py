### Cloned and adapted from https://github.com/roshansingh/python-tagcloud
...
class TagCloud(object):
	...
	FONT = '/Library/Fonts/DejaVuSansMono.ttf'
	...
	def _save(self):
		...
		self.image.save(self.imageFilePath, "JPEG", quality=100)
